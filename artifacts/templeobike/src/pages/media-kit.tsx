...
const media = [
  ...
  {
    title: 'Video Feature',
    description: 'A candid session with Temple Obike on the intersection of faith, mental health, and the modern African family.',
    outlet: 'YouTube',
    type: 'Video Feature',
    url: 'https://www.youtube.com/watch?v=-IitwHCVbYA',
    videoId: '-IitwHCVbYA',
    kind: 'video' as const,
  },
];
