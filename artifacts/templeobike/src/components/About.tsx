          ...
          >
            ...
            <div className="space-y-6 text-lg md:text-xl text-muted-foreground font-light leading-relaxed">
              <p className="text-foreground font-normal">
                Temple Obike is a Lagos-based psychotherapist, relationship interventionist, and business strategist who has spent his career helping individuals, couples, and brands move through fracture toward repair. 
              </p>
              <p>
                His work spans trauma resolution, emotional intelligence, and market entry strategy — a combination that has made him a recurring voice on Nigerian television and radio, and a recognized name in African branding and PR circles.
              </p>
              <p>
